...
let totalPositionRedSide=[]
//console.log(totalPositionRedSide)
export{totalPositionRedSide}
 ...
 data9=colorPosition[PhotoColor9]
  ...
  onButtonPress1 = () => {
      if(colorSwitch1==1){
        ...
        totalPositionRedSide=[data1,data2,data3,data4,data5,data6,data7,data8,data9,].join('')
        console.log(totalPositionRedSide)
      }
      if(colorSwitch1==2){
...
<Svg height="100%" width="100%" position='absolute' pointerEvents='none' >
  <Line x1="10%" y1="53%" x2="90%" y2="53%" stroke="white" strokeWidth="2" pointerEvents="none"/>
      ...
      <Svg height="100%" width="100%" position='absolute' pointerEvents='none' >
  <Line x1="10%" y1="20%" x2="10%" y2="70%" stroke="green" strokeWidth="10" pointerEvents="none"  />
  </Svg>
  <Svg height="100%" width="100%" position='absolute' pointerEvents='none' >
...
<Svg height="100%" width="100%" position='absolute' pointerEvents='none' >
  ...
  <Svg height="100%" width="100%" position='absolute' pointerEvents='none' >
  <Line x1="90%" y1="20%" x2="90%" y2="70%" stroke="blue" strokeWidth="10" pointerEvents="none"/>
  </Svg>


  <Svg height="100%" width="100%" position='absolute' pointerEvents='none' >
  <Line x1="8.5%" y1="20%" x2="91.5%" y2="20%" stroke="white" strokeWidth="10" pointerEvents="none"/>
</Svg>


  <Svg height="100%" width="100%" position='absolute' pointerEvents='none' >
  <Line x1="8.5%" y1="70%" x2="91.5%" y2="70%" stroke="yellow" strokeWidth="10" pointerEvents="none"/>
  </Svg>
      <View style={{flex:2}}>
      ...
      <Icon.Button
                    ...
                    <Icon.Button
                        ...
                        size={40}
                        //paddingHorizontal='4%'
                        onPress={() => {navigate('confirmYellow'), console.log(totalPositionRedSide), console.log('final')}}
                    >
