...
let totalPositionGreenSide=[]
//console.log(totalPositionGreenSide)
export{totalPositionGreenSide}
 ...
 data9=colorPosition[PhotoColor9]
  ...
  onButtonPress1 = () => {
      if(colorSwitch1==1){
        ...
        totalPositionGreenSide=[data1,data2,data3,data4,data5,data6,data7,data8,data9,].join('')
        console.log(totalPositionGreenSide)
      }
      if(colorSwitch1==2){
  ...
  <Line x1="8.5%" y1="70%" x2="91.5%" y2="70%" stroke="yellow" strokeWidth="10" pointerEvents="none"/>
      ...
      <Icon.Button
                    ...
                    <Icon.Button
                        ...
                        size={40}
                        //paddingHorizontal='4%'
                        onPress={() => {navigate('confirmRed'), console.log(totalPositionGreenSide), console.log('final')}}
                    >
