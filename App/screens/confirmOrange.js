...
let totalPositionOrangeSide=[]
//console.log(totalPositionOrangeSide)
export{totalPositionOrangeSide}
 ...
 data9=colorPosition[PhotoColor9]
  ...
  onButtonPress1 = () => {
      if(colorSwitch1==1){
        ...
        totalPositionOrangeSide=[data1,data2,data3,data4,data5,data6,data7,data8,data9,].join('')
        console.log(totalPositionOrangeSide)
      }
      if(colorSwitch1==2){
  ...
  <Line x1="8.5%" y1="70%" x2="91.5%" y2="70%" stroke="yellow" strokeWidth="10" pointerEvents="none"/>
      ...
      <Icon.Button
                    ...
                    <Icon.Button
                        ...
                        size={40}
                        //paddingHorizontal='4%'
                        onPress={() => {navigate('confirmYellow'), console.log(totalPositionOrangeSide), console.log('final')}}
                    >
